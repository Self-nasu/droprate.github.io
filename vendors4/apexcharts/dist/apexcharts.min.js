    ...
    var p = {
        ...
        z = function() {
            ...
            return s(t, [{
                ...
                value: function(t, e) {
                    ...
                    o.attr("clip-path", "url(#gridRectMask".concat(s.globals.cuid, ")")), s.config.dataLabels.enabled && this.totalItems > 50 && console.warn("WARNING: DataLabels are enabled but there are too many to display. This may cause performance issue when rendering.");
                ...
                value: function() {
                    ...
                    if (this.isHorizontal) a = (i = l.globals.gridHeight / l.globals.dataPoints) / this.seriesLen, l.globals.isXNumeric && (a = (i = l.globals.gridHeight / this.totalItems) / this.seriesLen), a = a * parseInt(this.barOptions.barHeight) / 100, o = this.baseLineInvertedY + l.globals.padHorizontal + (this.isReversed ? l.globals.gridWidth : 0) - (this.isReversed ? 2 * this.baseLineInvertedY : 0), e = (i - a * this.seriesLen) / 2;
                    else {
                        ...
                        r = l.globals.gridHeight - this.baseLineY[this.yaxisIndex] - (this.isReversed ? l.globals.gridHeight : 0) + (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0), t = l.globals.padHorizontal + (s - n * this.seriesLen) / 2
                    }
                    return {
                        x: t,
                        y: e,
                ...
                value: function(t) {
                    ...
                    if (a = u.move(r, b), n = u.move(r, b), d.globals.previousPaths.length > 0 && (n = this.getPathFrom(x, p)), o = void 0 === this.series[g][p] || null === this.series[g][p] ? r : r + this.series[g][p] / this.invertedYRatio - 2 * (this.isReversed ? this.series[g][p] / this.invertedYRatio : 0), a = a + u.line(o, b) + u.line(o, b + i - s) + u.line(r, b + i - s) + u.line(r, b), n = n + u.line(r, b) + u.line(r, b + i - s) + u.line(r, b + i - s) + u.line(r, b), d.globals.isXNumeric || (l += h), this.barOptions.colors.backgroundBarColors.length > 0 && 0 === g) {
                        m >= this.barOptions.colors.backgroundBarColors.length && (m = 0);
                        var v = this.barOptions.colors.backgroundBarColors[m],
                            y = u.drawRect(0, b - i * this.visibleI, d.globals.gridWidth, i * this.seriesLen, 0, v, this.barOptions.colors.backgroundBarOpacity);
                        c.add(y), y.node.classList.add("apexcharts-backgroundBar")
                    }
                    return {
                        pathTo: a,
                        pathFrom: n,
                ...
                value: function(t) {
                    ...
                    if (n = u.move(b, l), r = u.move(b, l), d.globals.previousPaths.length > 0 && (r = this.getPathFrom(x, p)), s = void 0 === this.series[g][p] || null === this.series[g][p] ? l : l - this.series[g][p] / this.yRatio[this.yaxisIndex] + 2 * (this.isReversed ? this.series[g][p] / this.yRatio[this.yaxisIndex] : 0), n = n + u.line(b, s) + u.line(b + o - h, s) + u.line(b + o - h, l) + u.line(b, l), r = r + u.line(b, l) + u.line(b + o - h, l) + u.line(b + o - h, l) + u.line(b, l), d.globals.isXNumeric || (i += a), this.barOptions.colors.backgroundBarColors.length > 0 && 0 === g) {
                        m >= this.barOptions.colors.backgroundBarColors.length && (m = 0);
                        var v = this.barOptions.colors.backgroundBarColors[m],
                            y = u.drawRect(b - o * this.visibleI, 0, o * this.seriesLen, d.globals.gridHeight, 0, v, this.barOptions.colors.backgroundBarOpacity);
                        c.add(y), y.node.classList.add("apexcharts-backgroundBar")
                    }
                    return {
                        pathTo: n,
        ...
        M = function(t) {
            ...
            return r(i, z), s(i, [{
                ...
                value: function(t, e, i, s, a, n) {
                    var r, o, l = this.w;
                    return this.isHorizontal ? (r = (r = s = l.globals.gridHeight / l.globals.dataPoints) * parseInt(l.config.plotOptions.bar.barHeight) / 100, n = this.baseLineInvertedY + l.globals.padHorizontal + (this.isReversed ? l.globals.gridWidth : 0) - (this.isReversed ? 2 * this.baseLineInvertedY : 0), e = (s - r) / 2) : (o = i = l.globals.gridWidth / l.globals.dataPoints, o = l.globals.isXNumeric ? (i = this.minXDiff / this.xRatio) * parseInt(this.barOptions.columnWidth) / 100 : o * parseInt(l.config.plotOptions.bar.columnWidth) / 100, a = this.baseLineY[this.yaxisIndex] + (this.isReversed ? l.globals.gridHeight : 0) - (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0), t = l.globals.padHorizontal + (i - o) / 2), {
                        x: t,
                        y: e,
                        yDivision: s,
                        xDivision: i,
                ...
                value: function(t) {
                    ...
                    if (l = null === this.series[f][p] ? e : e + this.series[f][p] / this.invertedYRatio - 2 * (this.isReversed ? this.series[f][p] / this.invertedYRatio : 0), this.xArrj.push(l), this.xArrjF.push(Math.abs(e - l)), this.xArrjVal.push(this.series[f][p]), n = this.graphics.move(e, g), r = this.graphics.move(e, g), u.globals.previousPaths.length > 0 && (r = this.bar.getPathFrom(x, p, !1)), n = n + this.graphics.line(l, g) + this.graphics.line(l, g + s - a) + this.graphics.line(e, g + s - a) + this.graphics.line(e, g), r = r + this.graphics.line(e, g) + this.graphics.line(e, g + s - a) + this.graphics.line(e, g + s - a) + this.graphics.line(e, g + s - a) + this.graphics.line(e, g), u.config.plotOptions.bar.colors.backgroundBarColors.length > 0 && 0 === f) {
                        m >= u.config.plotOptions.bar.colors.backgroundBarColors.length && (m = 0);
                        var w = u.config.plotOptions.bar.colors.backgroundBarColors[m],
                            k = this.graphics.drawRect(0, g, u.globals.gridWidth, s, 0, w, u.config.plotOptions.bar.colors.backgroundBarOpacity);
                ...
                value: function(t) {
                    ...
                    if (s = m - this.series[u][g] / this.yRatio[this.yaxisIndex] + 2 * (this.isReversed ? this.series[u][g] / this.yRatio[this.yaxisIndex] : 0), this.yArrj.push(s), this.yArrjF.push(Math.abs(m - s)), this.yArrjVal.push(this.series[u][g]), n = this.graphics.move(b, m), r = this.graphics.move(b, m), d.globals.previousPaths.length > 0 && (r = this.bar.getPathFrom(f, g, !1)), n = n + this.graphics.line(b, s) + this.graphics.line(b + o - h, s) + this.graphics.line(b + o - h, m) + this.graphics.line(b, m), r = r + this.graphics.line(b, m) + this.graphics.line(b + o - h, m) + this.graphics.line(b + o - h, m) + this.graphics.line(b + o - h, m) + this.graphics.line(b, m), d.config.plotOptions.bar.colors.backgroundBarColors.length > 0 && 0 === u) {
                        p >= d.config.plotOptions.bar.colors.backgroundBarColors.length && (p = 0);
                        var k = d.config.plotOptions.bar.colors.backgroundBarColors[p],
                            A = this.graphics.drawRect(b, 0, o, d.globals.gridHeight, 0, k, d.config.plotOptions.bar.colors.backgroundBarOpacity);
        ...
        R = function() {
            ...
            return s(t, [{
                ...
                value: function(t, e, i) {
                    ...
                    for (var u = this.xyRatios.zRatio, g = this.xyRatios.xRatio, p = this.xyRatios.baseLineY, x = [], m = [], b = 0, y = 0; y < t.length; y++) {
                        ...
                        if (j = this.determineFirstPrevY({
                            ...
                            for (var q = 0; q < t[y].length; q++)
                                if (null !== t[y][q]) {
                                    _ = k * q, j = P - t[y][q] / c[this.yaxisIndex], I = a.move(_, j), Y = a.move(_, E);
                                    break
                                }
                        } else I = a.move(_, j), Y = a.move(_, E) + a.line(_, j);
                        if (F = a.move(-1, P) + a.line(-1, P), R = a.move(-1, P) + a.line(-1, P), s.globals.previousPaths.length > 0) {
                        ...
                        for (var $ = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, J = 0; J < $; J++) {
                            ...
                            s.config.chart.stacked ? (U = y > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? m[y - 1][J + 1] : P, X = void 0 === t[y][J + 1] || null === t[y][J + 1] ? U - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : U - t[y][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[y][J + 1] / c[this.yaxisIndex] : 0)) : X = void 0 === t[y][J + 1] || null === t[y][J + 1] ? P - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : P - t[y][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[y][J + 1] / c[this.yaxisIndex] : 0), M.push(T), z.push(X);
                            ...
                            D = tt.areaPaths, O = tt.linePaths, B = tt.pX, G = tt.pY, Y = tt.areaPath, I = tt.linePath, this.appendPathFrom && (F += a.line(T, P), R += a.line(T, P));
                            ...
                            var at = new L(this.ctx).drawDataLabel(et, C, J + 1);
                            null !== at && W.add(at)
                        }
                        ...
                        if ("area" === o)
                            for (var rt = r.fillPath({
                                    seriesNumber: C
                                }), ot = 0; ot < D.length; ot++) {
                                var lt = a.renderPaths(n({}, nt, {
                                    pathFrom: R,
                                    pathTo: D[ot],
                                    stroke: "none",
                                    strokeWidth: 0,
                    ...
                    for (var ut = x.length; ut > 0; ut--) l.add(x[ut - 1]);
                    return l
                }
            }, {
                key: "createPaths",
        ...
        O = function() {
            ...
            return s(t, [{
                ...
                value: function() {
                    var t = this.w;
                    t.globals.dom.baseEl.querySelectorAll(".apexcharts-yaxis").forEach(function(e, i) {
            ...
            return s(t, [{
                    ...
                    if (e.config.xaxis.labels.show)
                        for (var d = 0; d <= c - 1; d++) {
                            var u = void 0 === r[d] ? "" : r[d],
                                g = void 0;
                            g = new D(this.ctx).xLabelFormat(l, u), void 0 !== h && (g = h(u, this.xaxisLabels[d], d));
                ...
                value: function(t) {
                    ...
                    if (s.config.xaxis.axisBorder.show) {
                        ...
                        r.add(b), new O(this.ctx).drawAxisTicks(0, l.length, s.config.yaxis[0].axisBorder, s.config.yaxis[0].axisTicks, 0, e, r)
                    }
                    return r
                }
            }, {
        ...
        W = function() {
            ...
            return s(t, [{
                ...
                value: function() {
                    ...
                    if (("line" === e.chart.type || "area" === e.chart.type || "candlestick" === e.chart.type) && t.minY === Number.MIN_VALUE && i !== -Number.MAX_VALUE) {
                        var f = t.maxY - i;
            ...
            return s(t, [{
                ...
                value: function() {
                    ...
                    if (e.globals.timelineLabels.length > 0) {
                        ...
                        n = new D(this.ctx).xLabelFormat(r, n);
    ...
    function $(t, e) {
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) {
                var i = e.then;
                if (e instanceof q) return t._state = 3, t._value = e, void Q(t);
                    ...
                    if (!(!e.config.plotOptions.bar.horizontal || "bar" !== e.config.chart.type)) {
                        if (t = n, e.config.grid.xaxis.lines.show || e.config.xaxis.axisTicks.show)
                            for (var o, l = e.globals.padHorizontal, h = e.globals.gridHeight, c = 0; c < t + 1 && (o = l = l + e.globals.gridWidth / t + .3, c !== t - 1); c++) {
                                ...
                                new N(this.ctx).drawXaxisTicks(l, a)
                            }
                        ...
                        if (t = this.xaxisLabels.length, e.config.grid.xaxis.lines.show || e.config.xaxis.axisTicks.show) {
                            ...
                            if (e.globals.timelineLabels.length > 0)
                                for (var w = 0; w < t; w++) {
                                    ...
                                    new N(this.ctx).drawXaxisTicks(v, a)
                                } else
            ...
            return s(t, [{
                ...
                value: function() {
                    ...
                    if (t.globals.axisCharts ? t.globals.dom.baseEl.querySelectorAll(".apexcharts-series[data\\:realIndex]").forEach(function(t) {
                        ...
                        t.globals.collapsedSeries = [], t.globals.ancillaryCollapsedSeries = [], t.globals.collapsedSeriesIndices = [], t.globals.ancillaryCollapsedSeriesIndices = [], t.globals.risingSeries = i, t.config.series = s, this.ctx._updateSeries(t.config.series, t.config.chart.animations.dynamicAnimation.enabled)
                    }
                }
            }, {
        ...
        ht = function() {
            ...
            return s(t, [{
                ...
                value: function(t) {
                    ...
                    var c = n;
                    s.globals.isXNumeric && "datetime" === s.config.xaxis.type ? n = new D(this.ctx).xLabelFormat(s.globals.ttKeyFormatter, c) : n = s.globals.xLabelFormatter(c, l);
                    ...
                    case "A":
                        t = (e = function(t, e) {
                            var i, s, a, n, r, o, l, h, c, d, u, g, f, p, x, m, b, v, y, w, k, A, S, C, L, z, M = Math.abs(e[1]),
                                ...
                                R = new SVG.Point(I, Y),
                                O = [];
                            if (0 === M || 0 === P || F.x === R.x && F.y === R.y) return [
                                ["C", F.x, F.y, R.x, R.y, R.x, R.y]
                            ];
                            i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform((new SVG.Matrix).rotate(E)), (s = i.x * i.x / (M * M) + i.y * i.y / (P * P)) > 1 && (s = Math.sqrt(s), M *= s, P *= s);
                            a = (new SVG.Matrix).rotate(E).scale(1 / M, 1 / P).rotate(-E), F = F.transform(a), R = R.transform(a), n = [R.x - F.x, R.y - F.y], o = n[0] * n[0] + n[1] * n[1], r = Math.sqrt(o), n[0] /= r, n[1] /= r, l = o < 4 ? Math.sqrt(1 - o / 4) : 0, T === X && (l *= -1);
                            ...
                            for (k = 1, A = m.length; k < A; k++) w = m[k - 1][2], S = w.x, C = w.y, w = m[k][0], L = w.x, z = w.y, w = m[k][1], I = w.x, Y = w.y, O.push(["C", S, C, L, z, I, Y]);
                            return O
                        }(this.pos, t))[0]
                }
        ...
        function() {
            ...
            return s(i, [{
                ...
                value: function(t) {
                    ...
                    })), this.revertDefaultAxisMinMax()), t.xaxis && ((t.xaxis.min || t.xaxis.max) && this.forceXAxisUpdate(t), t.xaxis.categories && t.xaxis.categories.length && a.config.xaxis.convertedCatToNumeric && (t = b.convertCatToNumeric(t))), a.globals.collapsedSeriesIndices.length > 0 && this.clearPreviousPaths(), this._updateOptions(t, e, i, s)
                }
            }, {
                key: "_updateOptions",
                value: function(e) {
